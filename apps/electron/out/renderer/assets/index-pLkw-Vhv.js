...
const MessageTimeline = reactExports.forwardRef(
  function MessageTimeline2({ messages, timeline }, ref) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "message-list", ref, "aria-label": "消息流", children: combinedItems.map((item, index) => {
      if (item.kind === "message") {
        const message = item.data;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: `message message--${message.role}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "message__role", children: message.role === "user" ? "你" : "助手" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "message__content", children: message.content || "正在等待增量输出..." })
        ] }, message.id);
      }
      const entry = item.data;
      return /* @__PURE__ */ jsxRuntimeExports.jsx(ToolCard, { entry }, `tool-${entry.callId}-${index}`);
    }) });
  }
);
const modeHints = {
...
function ModulePage({ view }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "module-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "module-page__hero", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-kicker", children: content.kicker }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "module-page__title", children: content.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "module-page__description", children: content.description })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "module-page__actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "button button--ghost", children: content.secondaryAction }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "button button--primary", children: content.primaryAction })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "module-page__metrics", children: content.cards.map((card) => {
      const Icon2 = card.icon;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "module-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "module-card__icon-wrap", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "module-card__icon" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "module-card__label", children: card.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "module-card__value", children: card.value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "module-card__detail", children: card.detail })
      ] }, card.title);
    }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "module-page__grid", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "module-panel", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "module-panel__label", children: content.checklistTitle }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "module-panel__list module-panel__list--ordered", children: content.checklist.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: item }, item)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "module-panel", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "module-panel__label", children: content.notesTitle }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "module-panel__list", children: content.notes.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: item }, item)) })
      ] })
    ] })
  ] });
}
...
function startAgentRunWeb(options) {
...
function startAgentRunElectron(options) {
  ...
  void api.startRun(request).then(() => {
...
function subscribeBridgeHealth(onStateChange) {
...
function useAgentRun(updateSessionRecord) {
  ...
  const [bashConfirmCommands, setBashConfirmCommands] = reactExports.useState(null);
  ...
  const clearErrorOnBridgeReadyRef = reactExports.useRef(false);
  ...
  reactExports.useEffect(() => {
    if (bridgeState === "ready" && errorMessage && (isBridgeStatusMessage(errorMessage) || clearErrorOnBridgeReadyRef.current)) {
  ...
  const appendAssistantText = (runId, text) => {
    ...
    updateSessionRecord(sessionId, (session) => ({
      ...
      messages: session.messages.map(
        (message) => message.runId === runId ? { ...message, content: `${message.content}${text}` } : message
      )
    }));
  };
  ...
  const handleStreamEvent = (event) => {
    ...
    switch (event.type) {
      ...
      case "tool_call_started": {
        ...
        if (!sessionId) break;
        updateSessionRecord(sessionId, (session) => {
          const entry = { callId, toolName, inputSummary, status: "running" };
      ...
      case "tool_call_completed": {
        ...
        updateSessionRecord(sessionIdCompleted, (session) => {
          const entry = {
            callId,
            toolName,
            inputSummary: session.toolCalls.get(callId)?.inputSummary ?? toolName,
            status,
            resultPreview,
            outputText,
            outputTruncated,
          ...
          return {
            ...session,
            toolCalls: nextToolCalls,
            timeline: session.timeline.map(
              (item) => item.kind === "tool_call" && item.data.callId === callId ? { ...item, data: entry } : item
            )
          };
        });
        break;
